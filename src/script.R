...
## Boxplot Example ####
pairwiseComparisons.example <- function(data_table, labels, file, format = "pdf", 
                                test = "wilcox", threshold = 0.05, 
                                grouping, color_groups = NULL,
                                remove_outliers = FALSE,
                                subset = NULL,
...
## Heatmap Example ####
createHeatmap.example <- function(data_table, file, scale = TRUE, cluster_cols = FALSE, 
                          cluster_rows  =TRUE, dendrogram_cols  =FALSE,
                          dendrogram_rows = TRUE, grouping = NULL,
                          color_groups = NULL, subset = NULL,
                          palette = "RdBu"){
...
## PCA Example ####
pcaAnalysis.example <- function(data_table, file, grouping = NULL, color_groups = NULL, 
                        animal_label = FALSE){
